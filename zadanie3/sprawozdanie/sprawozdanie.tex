...
Wartości macro F1 dla wszystkich 25 eksperymentów zebrane są w Tab.~\ref{tab:f1}.
...
Wartości AUC \textit{macro} (one-vs-rest) dla wszystkich 25 eksperymentów zebrane są w Tab.~\ref{tab:auc}.
