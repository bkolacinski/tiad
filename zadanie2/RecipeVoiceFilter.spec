...
binaries = []
hiddenimports = ['whisper', 'whisper.audio', 'sklearn.feature_extraction.text', 'sklearn.metrics.pairwise', 'spacy', 'pl_core_news_sm', 'customtkinter', 'sounddevice', 'soundfile', 'argostranslate', 'ctranslate2', 'rapidfuzz', 'certifi']
...
datas += tmp_ret[0]; binaries += tmp_ret[1]; hiddenimports += tmp_ret[2]
tmp_ret = collect_all('pl_core_news_sm')
datas += tmp_ret[0]; binaries += tmp_ret[1]; hiddenimports += tmp_ret[2]
